...
<center><h3 class="titulo">Productos de Repostería Registrados</h3></center>
...
<tr>	
		<td width="30px" height="45px"><?php echo e($reposteria->id); ?></td>
		<td width="30px" height="45px"><?php echo e($reposteria->nombre); ?></td>
		<td width="30px" height="45px"><?php echo e($reposteria->descripcion); ?></td>
		<td width="30px" height="45px">$<?php echo e($reposteria->precio); ?></td>
		<td width="30px" height="45px"><?php echo e($reposteria->estatus); ?></td>
