...
<center><img src="/imgProductos/imgconlogo.png" img-responsive col-md-8 width="1348" height="300"></center>
...
<h3><center>Envía un Comentario</center> </h3>
<table>

	<tr>
			<form method="POST" action="/comentarios" onsubmit="">
				
					<td width="320px"><label for="nombre">Nombre:</label>
					 <input type="text" class="form-control" id="nombre" aria-describedby="nombre" required title="Solo letras. Tamaño mínimo: 3. Tamaño máximo: 25" placeholder="Coloca Nombre" name="nombre"></td>
	...
	<tr>	
						    ...
						    <td width="320px"><label for="mensaje">Mensaje:</label>
						    <input type="text" class="form-control" id="mensaje" aria-describedby="mensaje" required  title="Letras, numeros y caracteres diferentes. Tamaño mínimo: 5. Tamaño máximo: 225" placeholder="Escibe tu mensaje" name="mensaje"></td>
