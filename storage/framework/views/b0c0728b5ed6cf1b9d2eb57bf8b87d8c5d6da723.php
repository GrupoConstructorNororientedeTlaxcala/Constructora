...
<center><h1>Registrar Bizcocho</h1></center>

<form method="POST" action="/bizcocheria"  enctype="multipart/form-data">
<center>
<table width="750" heidth="1150">	
	...
	<tr>
			   ...
			   <td> <label for="descripción">Descripción:</label></td>
			    <td><input type="text" class="form-control" id="descripcion" aria-describedby="descripcion"  placeholder="Coloca Descripción" name="descripcion" required title="este campo es obligatorio"></td>
	...
	<tr>		
			    ...
			    <td><input type="text" class="form-control" id="precio" aria-describedby="precio"  placeholder="Coloca precio" name="precio" pattern="[0-9.]{1,5}" required></td>
